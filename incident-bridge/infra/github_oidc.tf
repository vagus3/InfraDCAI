...
# for temporary credentials. The alternative -- an IAM user's access key stored
# as a GitHub secret -- is a permanent credential that never rotates and is
# valid from anywhere if it leaks.
    ...
    Statement = [
      {
        ...
        Resource = "*" # this call is account-wide by design and cannot be scoped
      },
      {
        Sid    = "EcrPush"
        Effect = "Allow"
      ...
      {
        Sid      = "RunDeployOnThisInstanceOnly"
        Effect   = "Allow"
